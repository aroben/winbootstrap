...
function Install-Cygwin {
  ...
  $process = Start-Process -PassThru $cygwinInstaller --quiet-mode, --download, --site, http://mirrors.kernel.org, --local-package-dir, C:\ProgramData\Cygwin, --packages, openssh
